...
var displayUserMessage = function displayUserMessage(messageContent, messageType) {
  ...
  (0, _jquery.default)('#messageText').stop().hide().html(markup).fadeIn().delay(2000).fadeOut();
};
...
(0, _jquery.default)('#apiForm').on('submit', function (e) {
  e.preventDefault(); // get the value from the form

  var value = (0, _jquery.default)("[name='api-key']").val(); // run the form through the api check
 ...
 */
},{"jquery":"node_modules/jquery/dist/jquery.js","./Models/ApiCheck":"src/js/Models/ApiCheck.js","./Views/messageView":"src/js/Views/messageView.js","./Views/apiBarView":"src/js/Views/apiBarView.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
